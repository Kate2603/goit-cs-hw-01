...
class Parser:
    ...
    def factor(self):
        """Парсер для 'factor' правил граматики. Це може бути число або вираз у дужках."""
    ...
    def term(self):
        """Парсер для 'term' правил граматики. Це може бути множення або ділення."""
        node = self.factor()
...
class Interpreter:
    ...
    def visit_BinOp(self, node):
        print(f"Visiting BinOp: {node.op.type}")
